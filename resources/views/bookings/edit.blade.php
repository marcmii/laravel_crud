<x-app-layout>
    <x-slot name="header">
        <h1 class="text-2xl font-semibold text-slate-900">Editar reserva</h1>
    </x-slot>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <form method="POST" action="{{ route('bookings.update', $booking) }}" class="space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('bookings.show', $booking) }}" class="text-sm font-medium text-slate-600 hover:text-slate-900">Cancel·lar</a>
            </div>
        </form>
    </div>
</x-app-layout>
